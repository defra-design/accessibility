...
You should not use Power Apps as some accessibility issues cannot be fixed by us and there is no satisfactory plan from the supplier to provide fixes. 
If you are required to use Power Apps despite these issues, in the first instance you must follow the [Canvas Controls Accessibility Guidance](https://xgov-low-code.github.io/accessibility/canvas-controls/).
